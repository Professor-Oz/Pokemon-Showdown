...
let Formats = [
  ...
  },
  {
    ...
    team : 'random',
    ruleset : [
      'PotD', 'Obtainable', 'HP Percentage Mod', 'Cancel Mod',
      'Sleep Clause Mod'
    ],
  },
  {
  ...
  /*{
          ...
          threads: [
                  `&bullet; <a
  href="https://www.smogon.com/forums/threads/3656245/">OU Metagame
  Discussion</a>`,
          ],
  ...
  },*/
  {
    ...
    threads : [
      ...
      //`&bullet; <a href="https://www.smogon.com/forums/threads/3623296/">Ubers
      //Viability Rankings</a>`,
      //`&bullet; <a href="https://www.smogon.com/forums/threads/3639330/">Ubers
      //Sample Teams</a>`,
    ],
  ...
  },
  {
    ...
    maxLevel : 5,
    ruleset : [
      'Obtainable', 'Little Cup', 'Standard', 'Team Preview', 'Dynamax Clause'
    ],
    banlist : [
      'Cherubi', 'Corsola-Galar', 'Gastly', 'Gothita', 'Sneasel', 'Swirlix',
      'Moody', 'Baton Pass'
    ],
    minSourceGen : 8,
  },
  {
    ...
    threads : [
      ...
      //`&bullet; <a
      //href="https://www.smogon.com/forums/threads/3622349">Monotype Viability
      //Rankings</a>`,
      //`&bullet; <a
      //href="https://www.smogon.com/forums/threads/3599682/">Monotype Sample
      //Teams</a>`,
    ],
    ...
    banlist : [
      'Eternatus', 'Zacian', 'Zamazenta', 'Damp Rock', 'Smooth Rock',
  ...
  },
  {
    ...
    searchShow : false,
    ruleset : [
      'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
  ...
  },
  {
    ...
    banlist :
        [ 'Doublade', 'Rhydon', 'Type: Null', 'Shadow Tag', 'Baton Pass' ],
    minSourceGen : 8,
  },
  {
    name : "[Gen 8] 1v1",
    ...
    threads : [
      ...
      //`&bullet; <a href="https://www.smogon.com/forums/threads/3646758/">1v1
      //Viability Rankings</a>`,
      //`&bullet; <a href="https://www.smogon.com/forums/threads/3646826/">1v1
      //Sample Teams</a>`,
    ],
    ...
    ruleset : [
      'Obtainable', 'Species Clause', 'Nickname Clause', 'OHKO Clause',
      'Evasion Moves Clause', 'Accuracy Moves Clause', 'Team Preview',
      'HP Percentage Mod', 'Cancel Mod', 'Dynamax Clause',
      'Endless Battle Clause'
    ],
    banlist :
        [ 'Eternatus', 'Zacian', 'Zamazenta', 'Focus Sash', 'Perish Song' ],
    minSourceGen : 8,
  },
  {
    name : "[Gen 8] CAP",
    ...
    banlist : [
      'Crucibelle-Mega', 'Aurumoth + Quiver Dance', 'Crucibelle + Head Smash',
      'Crucibelle + Low Kick', 'Tomohawk + Earth Power', 'Tomohawk + Reflect'
    ],
  },
  {
  ...
  },
  {
    ...
    banlist : [
      'DUber', 'Gravity ++ Hypnosis', 'Gravity ++ Lovely Kiss',
      'Gravity ++ Sing', 'Gravity ++ Sleep Powder'
    ],
    minSourceGen : 8,
  },
  {
    ...
    banlist : [
      'Alcremie-Gmax', 'Appletun-Gmax', 'Charizard-Gmax ++ Solar Power',
      'Coalossal-Gmax', 'Copperajah-Gmax', 'Duraludon-Gmax', 'Flapple-Gmax',
      'Garbodor-Gmax', 'Gengar-Gmax', 'Grimmsnarl-Gmax', 'Hatterene-Gmax',
      'Kingler-Gmax', 'Lapras-Gmax', 'Machamp-Gmax', 'Melmetal-Gmax',
      'Orbeetle-Gmax', 'Toxtricity-Gmax'
    ],
    minSourceGen : 8,
  },
  {
  ...
  },
  {
    ...
    ruleset : [
      'Obtainable', 'Standard Doubles', 'Accuracy Moves Clause', 'Team Preview',
      'Sleep Clause Mod'
    ],
    ...
    onValidateSet(set) {
      ...
      if (template.types.includes('Steel'))
        return [
          `${
              template
                  .species} is a Steel-type, which is banned from Metronome Battle.`
        ];
      let bst = 0;
      ...
      if (set.moves.length !== 1 ||
          this.dex.getMove(set.moves[0]).id !== 'metronome')
        return [
  ...
  },
  {
    ...
    mod : 'gen8',
    ruleset : [
      'Obtainable', 'Team Preview', 'Nickname Clause', 'Endless Battle Clause',
      'HP Percentage Mod', 'Cancel Mod', '+Past', 'NatDex Rule'
    ],
    unbanlist : [ 'Melmetal', 'Meltan' ],
  },
  ...
  },
  {
    ...
    ruleset : [
      'Obtainable', 'Species Clause', 'Nickname Clause', 'OHKO Clause',
      'Evasion Moves Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
      'Dynamax Clause', 'Sleep Clause Mod', 'Endless Battle Clause'
    ],
    banlist : [
      'Darmanitan-Galar',
      'Eternatus',
    ...
    onModifyTemplate(template, target, source, effect) {
      ...
      if (effect && [ 'imposter', 'transform' ].includes(effect.id))
        return;
      let types = [...new Set(target.baseMoveSlots.slice(0, 2).map(
          move => this.dex.getMove(move.id).type)) ];
      return Object.assign({}, template, {types : types});
    },
    onSwitchIn(pokemon) {
      this.add('-start', pokemon, 'typechange',
               pokemon.getTypes(true).join('/'), '[silent]');
    },
    onAfterMega(pokemon) {
      this.add('-start', pokemon, 'typechange',
               pokemon.getTypes(true).join('/'), '[silent]');
  ...
  },
  {
    ...
    mod : 'gen7',
    ruleset : [
      '-Nonexistent', '2 Ability Clause', 'OHKO Clause', 'Evasion Moves Clause',
      'CFZ Clause', 'Sleep Clause Mod', 'Endless Battle Clause',
      'HP Percentage Mod', 'Cancel Mod', 'Team Preview'
    ],
    banlist : [
      ...
      'Moody',          'Parental Bond',
      'Protean',        'Psychic Surge',
      'Pure Power',     'Shadow Tag',
      'Stakeout',       'Water Bubble',
      'Wonder Guard',   'Gengarite',
      'Chatter',        'Comatose + Sleep Talk'
    ],
  },
  ...
  },
  {
    ...
    mod : 'gen8',
    ruleset : [
      '-Nonexistent', 'Obtainable Formes', 'OHKO Clause',
      'Evasion Moves Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
      'Sleep Clause Mod', 'Endless Battle Clause'
    ],
    banlist : [
      'Arena Trap',
      'Contrary',
  ...
  },
  {
    ...
    threads : [
      ...
      //`&bullet; <a href="https://www.smogon.com/forums/threads/3595753/">AAA
      //Resources</a>`,
    ],

    mod : 'gen8',
    ruleset : [
      'Obtainable', '!Obtainable Abilities', 'Species Clause',
      'Nickname Clause', '2 Ability Clause', 'OHKO Clause',
      'Evasion Moves Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
      'Sleep Clause Mod', 'Endless Battle Clause'
    ],
    banlist : [
      'Eternatus',    'Shedinja',      'Zacian',      'Zamazenta',
      'Baton Pass',   'Arena Trap',    'Comatose',    'Contrary',
      'Fluffy',       'Fur Coat',      'Huge Power',  'Ice Scales',
      'Illusion',     'Imposter',      'Innards Out', 'Libero',
      'Moody',        'Parental Bond', 'Protean',     'Pure Power',
      'Shadow Tag',   'Simple',        'Stakeout',    'Speed Boost',
  ...
  },
  {
    ...
    restrictedMoves : [
      'Acupressure', 'Belly Drum', 'Fishious Rend', 'Shell Smash', 'Shift Gear',
      'Spore'
    ],
    minSourceGen : 8,
  },
  {
    ...
    desc :
        `Mega evolve any Pok&eacute;mon with any mega stone and no limit. Boosts based on mega evolution from gen 7.`,
    threads : [
      `&bullet; <a href="https://www.smogon.com/forums/threads/3656469/">Mix and Mega</a>`,
      //`&bullet; <a href="https://www.smogon.com/forums/threads/3591580/">Mix
      //and Mega Resources</a>`,
    ],
    ...
    onValidateTeam(team, format) {
      ...
      for (const set of team) {
        ...
        if (!item || !item.megaStone)
          continue;
        let template = this.dex.getTemplate(set.species);
        if (format.banlist.includes('AG') &&
            [ 'Venusaur', 'Blastoise', 'Eternatus', 'Zamazenta' ].includes(
    ...
    onSwitchIn(pokemon) {
      ...
      if (oMegaTemplate.exists &&
          pokemon.m.originalSpecies !== oMegaTemplate.baseSpecies) {
        ...
        if (oTemplate.types.length !== pokemon.template.types.length ||
            oTemplate.types[1] !== pokemon.template.types[1]) {
          this.add('-start', pokemon, 'typechange',
                   pokemon.template.types.join('/'), '[silent]');
        }
      }
    },
    onSwitchOut(pokemon) {
  ...
  },
  {
    ...
    desc :
        "Pok&eacute;mon below OU get all their stats boosted. UU/RUBL get +10, RU/NUBL get +20, NU/PUBL get +30, and PU or lower get +40.",
    threads : [
    ...
    ruleset : [ '[Gen 7] OU' ],
    banlist :
        [ 'Drought', 'Damp Rock', 'Deep Sea Tooth', 'Eviolite', 'Heat Rock' ],
    onModifyTemplate(template, target, source, effect) {
      ...
      if (target && target.set.ability === 'Drizzle')
        return;
      let tier = template.tier;
      if (target && target.set.item) {
        let item = this.dex.getItem(target.set.item);
        if (item.name === 'Kommonium Z' || item.name === 'Mewnium Z')
          return;
        if (item.megaEvolves === template.species)
          tier = this.dex.getTemplate(item.megaStone).tier;
      }
      if (target && target.set.moves.includes('auroraveil'))
        tier = 'UU';
      if (target && target.set.ability === 'Drought')
        tier = 'RU';
      ...
      for (let statName in pokemon.baseStats) {
        ...
        pokemon.baseStats[statName] =
            this.dex.clampIntRange(pokemon.baseStats[statName] + boost, 1, 255);
      }
      return pokemon;
    },
  },
  ...
  },
  {
    ...
    team : 'random',
    ruleset : [
      'Obtainable', 'Same Type Clause', 'HP Percentage Mod', 'Cancel Mod',
      'Sleep Clause Mod'
    ],
  },
  {
    ...
    ruleset : [
      'Obtainable', 'HP Percentage Mod', 'Cancel Mod', 'Team Preview',
      'Dynamax Clause'
    ],
  },
  {
  ...
  },
  {
    ...
    desc :
        `Randomized teams of level-balanced Pok&eacute;mon with absolutely any ability, moves, and item.`,
  ...
  },
  {
    ...
    team : 'random',
    ruleset :
        [ 'Obtainable', 'Sleep Clause Mod', 'HP Percentage Mod', 'Cancel Mod' ],
  },
  {
  ...
  },
  {
    ...
    desc :
        `Randomized teams of Pok&eacute;mon for a generated Smogon tier with sets that are competitively viable.`,

    mod : 'gen7',
    team : 'randomFactory',
    searchShow : false,
    ruleset : [
      'Obtainable', 'Sleep Clause Mod', 'Team Preview', 'HP Percentage Mod',
  ...
  },
  {
    ...
    searchShow : false,
    ruleset : [
      'Obtainable', 'Allow AVs', 'HP Percentage Mod', 'Cancel Mod',
      'Sleep Clause Mod'
    ],
  },
  {
  ...
  },
  {
    ...
    banlist : [
      'Snorlax', 'Hypnosis', 'Lovely Kiss', 'Sing', 'Sleep Powder', 'Spore',
      'Swagger'
    ],
  },
  {
  ...
  },
  {
    ...
    mod : 'gen5',
    ruleset : [
      'Obtainable', 'Standard', 'Evasion Abilities Clause', 'Baton Pass Clause',
      'Swagger Clause', 'Team Preview'
    ],
    banlist : [
      'Uber', 'Arena Trap', 'Drizzle ++ Swift Swim', 'Drought ++ Chlorophyll',
      'Sand Rush', 'Shadow Tag', 'Soul Dew'
    ],
  },
  {
    name : "[Gen 4] OU",
  ...
  },
  {
    ...
    mod : 'gen7',
    ruleset :
        [ 'Obtainable', 'Standard', 'Team Preview', 'Mega Rayquaza Clause' ],
    banlist : [ 'Baton Pass' ],
  },
  {
    name : "[Gen 7] UU",
    ...
    ruleset : [ '[Gen 7] OU' ],
    banlist :
        [ 'OU', 'UUBL', 'Drizzle', 'Drought', 'Kommonium Z', 'Mewnium Z' ],
  },
  {
    name : "[Gen 7] RU",
    threads : [
  ...
  },
  {
    ...
    maxLevel : 5,
    ruleset : [
      'Obtainable', 'Little Cup', 'Standard', 'Swagger Clause', 'Team Preview'
    ],
    banlist : [
      'Aipom',      'Cutiefly',   'Drifloon', 'Gligar',     'Gothita',
      'Meditite',   'Misdreavus', 'Murkrow',  'Porygon',    'Scyther',
      'Sneasel',    'Swirlix',    'Tangela',  'Trapinch',   'Vulpix-Base',
      'Wingull',    'Yanma',      'Eevium Z', 'Baton Pass', 'Dragon Rage',
      'Sonic Boom',
    ],
  },
  {
    ...
    mod : 'gen7',
    ruleset : [
      'Obtainable', 'Same Type Clause', 'Standard', 'Swagger Clause',
      'Team Preview'
    ],
    banlist : [
      'Aegislash',
  ...
  },
  {
    ...
    ruleset : [
      'Obtainable', 'Species Clause', 'Nickname Clause', 'OHKO Clause',
      'Swagger Clause', 'Evasion Moves Clause', 'Accuracy Moves Clause',
  ...
  },
  {
    ...
    banlist : [
      'Aurumoth + Quiver Dance',
      'Crucibelle + Head Smash',
      'Crucibelle + Low Kick',
      'Tomohawk + Earth Power',
      'Tomohawk + Reflect',
    ],
  },
  {
  ...
  },
  {
    ...
    gameType : 'doubles',
    ruleset :
        [ 'Obtainable', 'Standard Doubles', 'Swagger Clause', 'Team Preview' ],
    banlist : [
      'DUber', 'Power Construct', 'Eevium Z', 'Dark Void',
      'Gravity ++ Grass Whistle', 'Gravity ++ Hypnosis',
      'Gravity ++ Lovely Kiss', 'Gravity ++ Sing', 'Gravity ++ Sleep Powder'
    ],
  },
  {
  ...
  },
  {
    ...
    ruleset : [ 'Obtainable', 'Standard GBU' ],
    banlist : [
      'Unown', 'Custap Berry', 'Enigma Berry', 'Jaboca Berry', 'Micle Berry',
      'Rowap Berry'
    ],
    minSourceGen : 7,
  },
  {
    ...
    ruleset : [
      'Obtainable', 'Alola Pokedex', 'Species Clause', 'Nickname Clause',
      'Item Clause', 'Team Preview', 'Cancel Mod'
    ],
    banlist : [
      'Solgaleo',
      'Lunala',
  ...
  },
  {
    ...
    searchShow : false,
    ruleset : [
      'Obtainable', 'Standard', 'Swagger Clause', 'Team Preview',
  ...
  },
  {
    ...
    banlist : [
      'LC Uber', 'Gligar', 'Misdreavus', 'Scyther', 'Sneasel', 'Tangela',
  ...
  },
  {
    ...
    searchShow : false,
    ruleset : [
      'Obtainable', 'Standard', 'Swagger Clause', 'Same Type Clause',
      'Team Preview'
    ],
    banlist : [
      'Aegislash',     'Altaria-Mega',     'Arceus',
      'Blaziken',      'Charizard-Mega-X', 'Darkrai',
      'Deoxys-Base',   'Deoxys-Attack',    'Dialga',
      'Genesect',      'Gengar-Mega',      'Giratina',
      'Greninja',      'Groudon',          'Ho-Oh',
      'Hoopa-Unbound', 'Kangaskhan-Mega',  'Kyogre',
      'Kyurem-White',  'Lucario-Mega',     'Lugia',
      'Mawile-Mega',   'Medicham-Mega',    'Metagross-Mega',
      'Mewtwo',        'Palkia',           'Rayquaza',
      'Reshiram',      'Sableye-Mega',     'Salamence-Mega',
      'Shaymin-Sky',   'Slowbro-Mega',     'Talonflame',
      'Xerneas',       'Yveltal',          'Zekrom',
      'Shadow Tag',    'Damp Rock',        'Smooth Rock',
      'Soul Dew',      'Baton Pass',
    ],
  },
  {
    ...
    searchShow : false,
    ruleset : [
      'Obtainable', 'Team Preview', 'Endless Battle Clause',
  ...
  },
  {
    ...
    ruleset : [
      'Obtainable', 'Nickname Clause', 'Moody Clause', 'OHKO Clause',
      'Evasion Moves Clause', 'Accuracy Moves Clause', 'Swagger Clause',
      'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod', 'Team Preview'
    ],
    banlist : [
      'Arceus',        'Blaziken',       'Darkrai',         'Deoxys-Base',
      'Deoxys-Attack', 'Deoxys-Defense', 'Dialga',          'Giratina',
      'Groudon',       'Ho-Oh',          'Kangaskhan-Mega', 'Kyogre',
      'Kyurem-White',  'Lugia',          'Mewtwo',          'Palkia',
      'Rayquaza',      'Reshiram',       'Salamence-Mega',  'Shaymin-Sky',
      'Xerneas',       'Yveltal',        'Zekrom',          'Focus Sash',
  ...
  },
  {
    ...
    ruleset :
        [ 'Obtainable', 'Standard Doubles', 'Swagger Clause', 'Team Preview' ],
    banlist : [
      'DUber', 'Soul Dew', 'Dark Void', 'Gravity ++ Grass Whistle',
      'Gravity ++ Hypnosis', 'Gravity ++ Lovely Kiss', 'Gravity ++ Sing',
  ...
  },
  {
    ...
    ruleset : [
      'Obtainable', 'Species Clause', 'Nickname Clause', 'Item Clause',
      'Team Preview', 'Cancel Mod'
    ],
    banlist : [
      'Mew',           'Celebi',         'Jirachi',      'Deoxys',
      'Deoxys-Attack', 'Deoxys-Defense', 'Deoxys-Speed', 'Phione',
      'Manaphy',       'Darkrai',        'Shaymin',      'Shaymin-Sky',
      'Arceus',        'Victini',        'Keldeo',       'Meloetta',
      'Genesect',      'Diancie',        'Hoopa',        'Hoopa-Unbound',
      'Volcanion',     'Soul Dew',
    ],
    minSourceGen : 6,
    onValidateTeam(team) {
  ...
  },
  {
    ...
    banlist : [
      'Uber', 'OU', 'UUBL', 'Arena Trap', 'Drought', 'Sand Stream',
      'Snow Warning'
    ],
  },
  {
  ...
  },
  {
    ...
    banlist : [
      ...
      'Cacturne',   'Camerupt',    'Carracosta', 'Charizard',  'Combusken',
      'Eelektross', 'Electabuzz',  'Exeggutor',  'Garbodor',   'Gardevoir',
      'Gigalith',   'Golem',       'Golurk',     'Gorebyss',   'Gurdurr',
      'Haunter',    'Jynx',        'Kadabra',    'Kangaskhan', 'Lapras',
      'Lickilicky', 'Liepard',     'Linoone',    'Ludicolo',   'Mandibuzz',
      'Metang',     'Miltank',     'Misdreavus', 'Musharna',   'Piloswine',
      'Pinsir',     'Primeape',    'Probopass',  'Regirock',   'Roselia',
      'Rotom-Fan',  'Rotom-Frost', 'Samurott',   'Sawk',       'Sawsbuck',
      'Scolipede',  'Seismitoad',  'Serperior',  'Skuntank',   'Swellow',
      'Tangela',    'Tauros',      'Torkoal',    'Wartortle',  'Weezing',
      'Zangoose',
    ],
  },
  {
    ...
    ruleset : [ 'Obtainable', 'Standard', 'Team Preview', 'Little Cup' ],
    banlist : [
      'Berry Juice', 'Soul Dew', 'Dragon Rage', 'Sonic Boom', 'LC Uber',
      'Sand Rush', 'Gligar', 'Murkrow', 'Scyther', 'Sneasel', 'Tangela'
    ],
  },
  {
    name : "[Gen 5] Monotype",
  ...
  },
  {
    ...
    ruleset : [
      'Obtainable', 'Standard', 'Baton Pass Clause', 'Swagger Clause',
      'Team Preview'
    ],
    banlist : [ 'Uber', 'Whimsicott', 'Focus Sash', 'Soul Dew', 'Perish Song' ],
    unbanlist :
        [ 'Genesect', 'Landorus', 'Manaphy', 'Thundurus', 'Tornadus-Therian' ],
  },
  {
  ...
  },
  {
    ...
    searchShow : false,
    ruleset : [
      'Obtainable', 'Standard', 'Evasion Abilities Clause', 'Swagger Clause',
      'Team Preview'
    ],
  ...
  },
  {
    ...
    ruleset : [ '[Gen 4] NU' ],
    banlist : [
      'Articuno',  'Cacturne',  'Charizard',  'Cradily',    'Dodrio',
      'Drifblim',  'Dusclops',  'Electrode',  'Gardevoir',  'Gligar',
      'Golem',     'Grumpig',   'Haunter',    'Hitmonchan', 'Hypno',
      'Jumpluff',  'Jynx',      'Lickilicky', 'Linoone',    'Magmortar',
      'Magneton',  'Manectric', 'Medicham',   'Meganium',   'Nidoqueen',
      'Ninetales', 'Piloswine', 'Poliwrath',  'Porygon2',   'Regice',
      'Regirock',  'Roselia',   'Sandslash',  'Sharpedo',   'Shiftry',
      'Skuntank',  'Slowking',  'Tauros',     'Typhlosion', 'Venomoth',
      'Vileplume',
    ],
  },
  {
  ...
  },
  {
    ...
    searchShow : false,
    ruleset : [
      'Obtainable', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod'
    ],
  },
  {
    name : "[Gen 4] 1v1",
  ...
  },
  {
    ...
    unbanlist : [
      'Garchomp', 'Latias', 'Latios', 'Manaphy', 'Mew', 'Salamence',
      'Wobbuffet', 'Wynaut'
    ],
  },
  {
  ...
  },
  {
    ...
    banlist : [
      'Slaking', 'Snorlax', 'Suicune', 'Destiny Bond', 'Explosion', 'Ingrain',
  ...
  },
  {
    ...
    searchShow : false,
    ruleset : [
      'Obtainable', 'Allow Tradeback', 'Sleep Clause Mod', 'Freeze Clause Mod',
      'Species Clause', 'OHKO Clause', 'Evasion Moves Clause',
      'HP Percentage Mod', 'Cancel Mod'
    ],
    banlist : [
      'Uber',
